...
: QWidget(parent)
{
   ...
   // setFixedSize(450, 300);
    ...
    QString str = QString("QFrame#avatar{border-image:url(:/pictures/%1.bmp)}").arg(QString::number(num));
    ...
    connect(ui.quitPushButton, SIGNAL(clicked()),this, SLOT(clickedQuitButton()) );
    connect(ui.OKPushButton, SIGNAL(clicked()),	this, SLOT(clickedOKButton()) );
    //connect(ui.helpPushButton, SIGNAL(clicked()),	this, SLOT(clickedHelpButton()) );
}
